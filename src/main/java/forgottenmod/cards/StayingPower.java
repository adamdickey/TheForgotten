...
public class StayingPower extends BaseCard {
    public static final String ID = makeID("Staying Power"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new StayingPowerPower(magicNumber), magicNumber));
    }
}
