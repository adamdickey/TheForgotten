...
public class DiscardVulnAttack extends BaseCard {
    public static final String ID = makeID("Discard Vuln Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
