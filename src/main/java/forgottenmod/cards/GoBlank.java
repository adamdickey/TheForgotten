...
public class GoBlank extends BaseCard {
    public static final String ID = makeID("Go Blank"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
