...
public class ShieldDance extends BaseCard {
    public static final String ID = makeID("Shield Dance"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        for(int i = 0; i < magicNumber; i++){
            ...
            addToBot(new MakeTempCardInHandAction(shield));
        }
    }
}
