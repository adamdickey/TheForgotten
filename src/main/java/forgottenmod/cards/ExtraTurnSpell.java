...
import forgottenmod.powers.DrawReduction2Power;
import forgottenmod.util.CardStats;
import theforgotten.TheForgotten;

public class ExtraTurnSpell extends BaseCard {
    public static final String ID = makeID("Extra Turn Spell"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
