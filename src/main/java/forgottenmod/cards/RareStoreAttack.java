...
public class RareStoreAttack extends BaseCard {
    public static final String ID = makeID("Rare Store Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
