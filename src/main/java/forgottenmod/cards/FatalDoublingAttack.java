...
import forgottenmod.actions.DoublingAction;
import forgottenmod.util.CardStats;
import theforgotten.TheForgotten;

public class FatalDoublingAttack extends BaseCard {
    public static final String ID = makeID("Fatal Doubling Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new DoublingAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn), this));
    }
}
