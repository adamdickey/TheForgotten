...
public class MasterReality extends BaseCard {
    public static final String ID = makeID("Master Reality"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
