...
public class MindControl extends BaseCard {
    public static final String ID = makeID("Mind Control"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
