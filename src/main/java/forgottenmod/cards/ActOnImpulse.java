...
public class ActOnImpulse extends BaseCard {
    public static final String ID = makeID("Act on Impulse"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
