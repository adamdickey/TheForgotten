...
public class EnergyStorage extends BaseCard {
    public static final String ID = makeID("Energy Storage"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
