...
public class Remember extends BaseCard {
    public static final String ID = makeID("Remember"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
