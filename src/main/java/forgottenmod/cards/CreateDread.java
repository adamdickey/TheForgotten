...
public class CreateDread extends BaseCard {
    public static final String ID = makeID("Create Dread"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
