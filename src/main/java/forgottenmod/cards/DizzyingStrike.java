...
public class DizzyingStrike extends BaseCard {
    public static final String ID = makeID("Dizzying Strike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new MakeTempCardInHandAction(new Dazed(), magicNumber));
    }
}
