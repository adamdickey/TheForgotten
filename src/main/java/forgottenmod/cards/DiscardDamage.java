...
public class DiscardDamage extends BaseCard {
    public static final String ID = makeID("Discard Damage"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
