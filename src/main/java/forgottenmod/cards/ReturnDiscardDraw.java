...
public class ReturnDiscardDraw extends BaseCard {
    public static final String ID = makeID("Return Discard Draw"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
