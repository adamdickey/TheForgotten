...
public class HandStrength extends BaseCard {
    public static final String ID = makeID("Hand Strength"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
