...
public class Reorganize extends BaseCard {
    public static final String ID = makeID("Reorganize"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
