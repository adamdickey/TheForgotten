...
public class FullWeakAttack extends BaseCard {
    public static final String ID = makeID("Full Weak Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
