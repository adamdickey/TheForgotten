...
public class ExhaustDexterity extends BaseCard {
    public static final String ID = makeID("Exhaust Dexterity"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
