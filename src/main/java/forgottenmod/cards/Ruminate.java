...
public class Ruminate extends BaseCard {
    public static final String ID = makeID("Ruminate"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
