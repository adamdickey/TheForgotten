...
public class RetainDefend extends BaseCard {
    public static final String ID = makeID("Retain Defend"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new RetainThisTurn(1)));
    }
}
