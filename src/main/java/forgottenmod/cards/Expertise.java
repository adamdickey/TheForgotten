...
public class Expertise extends BaseCard {
    public static final String ID = makeID("Expertise"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
