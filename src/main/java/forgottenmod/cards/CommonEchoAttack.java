...
public class CommonEchoAttack extends BaseCard {
    public static final String ID = makeID("Common Echo Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
