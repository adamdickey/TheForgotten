...
import forgottenmod.powers.LastStandPower;
import forgottenmod.util.CardStats;
import theforgotten.TheForgotten;

public class LastStand extends BaseCard {
    public static final String ID = makeID("Last Stand"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new LastStandPower(magicNumber), magicNumber));
    }
}
