...
import forgottenmod.powers.StoreNextCardPower;
import forgottenmod.util.CardStats;
import theforgotten.TheForgotten;

public class StoreNextCard extends BaseCard {
    public static final String ID = makeID("Store Next Card"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
