...
import forgottenmod.actions.StrikeHandAction;
import forgottenmod.util.CardStats;
import theforgotten.TheForgotten;

public class StrikeHand extends BaseCard {
    public static final String ID = makeID("Strike Hand"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
