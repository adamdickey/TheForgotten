...
public class Obsession extends BaseCard {
    public static final String ID = makeID("Obsession"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
