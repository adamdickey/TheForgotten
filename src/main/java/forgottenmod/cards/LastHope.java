...
import forgottenmod.powers.LastHopePower;
import forgottenmod.util.CardStats;
import theforgotten.TheForgotten;

public class LastHope extends BaseCard {
    public static final String ID = makeID("Last Hope"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new LastHopePower(magicNumber), magicNumber));
    }
}
