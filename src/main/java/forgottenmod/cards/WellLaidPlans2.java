...
public class WellLaidPlans2 extends BaseCard {
    public static final String ID = makeID("Well-Laid Plans"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
