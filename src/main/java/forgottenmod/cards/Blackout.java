...
public class Blackout extends BaseCard {
    public static final String ID = makeID("Blackout"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
