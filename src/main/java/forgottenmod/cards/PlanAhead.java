...
public class PlanAhead extends BaseCard {
    public static final String ID = makeID("Plan Ahead"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
