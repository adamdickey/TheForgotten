...
public class ScrapeTheMind extends BaseCard {
    public static final String ID = makeID("Scrape the Mind"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
