...
public class MemoryAttack extends BaseCard {
    public static final String ID = makeID("Memory Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
