...
public class ForgetThePain extends BaseCard {
    public static final String ID = makeID("Forget the Pain"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
