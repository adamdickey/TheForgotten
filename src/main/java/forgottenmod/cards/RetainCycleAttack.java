...
public class RetainCycleAttack extends BaseCard {
    public static final String ID = makeID("Retain Cycle Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void atTurnStart(){
        if(!(player.hand.group.contains(this))){
            retained = false;
        }
    }
