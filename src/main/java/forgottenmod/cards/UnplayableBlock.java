...
public class UnplayableBlock extends BaseCard {
    public static final String ID = makeID("Unplayable Block"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
