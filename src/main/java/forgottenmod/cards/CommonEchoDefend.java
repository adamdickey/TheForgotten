...
public class CommonEchoDefend extends BaseCard {
    public static final String ID = makeID("Common Echo Defend"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
