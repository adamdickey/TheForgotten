...
public class RetainTrauma extends BaseCard {
    public static final String ID = makeID("Retain Trauma"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new RetainTraumaAction(magicNumber, m, this));
