...
public class DiscardableDefend extends BaseCard {
    public static final String ID = makeID("Discardable Defend"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
