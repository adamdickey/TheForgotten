...
public class Scrawl2 extends BaseCard {
    public static final String ID = makeID("Scrawl 2"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
