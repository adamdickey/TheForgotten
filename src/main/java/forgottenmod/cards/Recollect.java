...
public class Recollect extends BaseCard {
    public static final String ID = makeID("Recollect"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
