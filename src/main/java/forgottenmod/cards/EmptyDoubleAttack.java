...
public class EmptyDoubleAttack extends BaseCard {
    public static final String ID = makeID("Empty Double Attack"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
