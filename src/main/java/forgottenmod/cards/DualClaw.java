...
public class DualClaw extends BaseCard {
    public static final String ID = makeID("Dual Claw"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
